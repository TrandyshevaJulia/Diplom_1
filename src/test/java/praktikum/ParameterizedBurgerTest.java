...
public class ParameterizedBurgerTest {
    ...
    public ParameterizedBurgerTest(String bunName, float bunPrice, String ingredient1Type, String ingredient1Name, float ingredient1Price, String ingredient2Type, String ingredient2Name, float ingredient2Price, String expectedReceipt) {
